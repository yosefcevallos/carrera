...
export default function MyStrip() {
  ...
  const rate = value > 0 ? held.reduce((a, t) => a + positions[t].stockAmount * vaults[t].priceUsd * trailingYield(vaults[t].sharePriceHistory, 30, vaults[t].priceUsd).apy, 0) / value : 0;
